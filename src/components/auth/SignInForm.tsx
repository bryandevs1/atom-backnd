...
export default function SignInForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://nexodus.tech/api/auth/login", {
        method: "POST",
        headers: {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    try {
      const response = await axios.post(
        "https://nexodus.tech/api/auth/google",
        {
      ...
      const redirectPath = response.data.user.role === "vendor" ? "/" : "/";
  ...
  const googlelogin = useGoogleLogin({
    ...
    flow: "implicit", // or 'auth-code' if you're using backend auth code flow
  });
        ...
        <div>
          <div className="mb-5 sm:mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              ...
              <strong>Note:</strong> This is for vendors only.
            </p>
          </div>
          <div>
